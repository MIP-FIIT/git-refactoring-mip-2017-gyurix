    ...
    public static class ObjectSerializer implements ConfigSerialization.Serializer {
        public Object fromData(ConfigData input, Class fixClass, Type... parameters) {
            try {
                ...
                if (ArrayUtils.contains(fixClass.getInterfaces(), ConfigSerialization.StringSerializable.class) || fixClass == BigDecimal.class || fixClass == BigInteger.class) {
                    if (input.stringData == null || input.stringData.equals(""))
                        return null;
        ...
        public ConfigData toData(Object obj, Type... parameters) {
            ...
            if (c.isEnum() || ArrayUtils.contains(c.getInterfaces(), ConfigSerialization.StringSerializable.class) || c == BigDecimal.class || c == BigInteger.class) {
